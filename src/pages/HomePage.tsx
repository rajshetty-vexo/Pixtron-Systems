  ...
  return (
    <>
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-40 overflow-hidden bg-white">
        ...
        <div className="max-w-7xl mx-auto px-1 md:px-2 lg:px-2 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-20">
            <div className="flex-1 text-center lg:text-left">
              ...
              >
                <a
                  href="/products"
                  className="bg-primary text-white px-10 py-5 rounded-full font-bold text-lg hover:bg-primary/95 transition-all shadow-2xl shadow-primary/30 flex items-center gap-3 group"
                >
                  Explore Solutions
                ...
                <a
                  href="/about"
                  className="flex items-center gap-4 px-8 py-4 text-slate-900 font-bold hover:text-primary transition-all group"
                >
        ...
        <div className="max-w-7xl mx-auto px-1 md:px-2 lg:px-2">
          <div className="bg-secondary rounded-[4rem] p-12 md:p-20 text-primary flex flex-col lg:flex-row items-center justify-between gap-12 relative overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col gap-4 w-full lg:w-auto">
              <a
                href="/contact"
                className="bg-primary text-white px-10 py-5 rounded-3xl font-black text-xl shadow-2xl hover:scale-105 transition-transform text-center"
              >
                Get Started Now
              </a>
