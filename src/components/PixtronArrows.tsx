...
export const PixtronArrows: React.FC<PixtronArrowsProps> = ({ 
  className, 
  size = 24, 
  variant = 'default' 
}) => {

  const secondArrowFill = variant === 'white' ? '#ffffff' : '#003985';
  ...
  return (
    ...
    >
      ...
      />
      {/* Second Arrow: Default Blue OR White */}
      <path
        fill={secondArrowFill}
